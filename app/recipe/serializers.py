...
class RecipeSerializers(serializers.ModelSerializer):
    ...
    def _get_or_create_tags(self, tags, recipe):
        ...
        #custom logic to overwrite default read only create for nested serialzer
        # "_" start means we cannot use outside recipe serializer
...
class RecipeDetailSerializer(RecipeSerializers):
    ...
    #pass in meta values so we extend it 
